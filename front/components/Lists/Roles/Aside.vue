...
const delay = ref()
const emit = defineEmits(['change-searchValue', 'set-new-role'])
const search = ref('')
...
<template>
  <div class="aside-deal__toggle h-[calc(100%-20px)] overflow-hidden">
    ...
    <!-- <div class="flex justify-center my-2">
      <button @click="setNewRole" class="py-2 mb-1 px-8 border-slate-400 border-dashed border-2 text-slate-600 font-medium text-[15px] rounded-lg w-full">
        Добавить роль
      </button>
    </div> -->
  </div>
