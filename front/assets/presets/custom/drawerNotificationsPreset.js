const ptDrawerNotifications = {
    root: ({ props }) => ({
        class: [
            // Flexbox
            'drawer-sidebar-notifictaions bg-surface-0 flex flex-col',
            ...
            'text-surface-200 dark:text-white/80',
    ...
    transition: ({ props }) => {
        return props.position === 'top'
            ...
            : props.position === 'left'
            ? {
                  enterFromClass: '-translate-x-full translate-y-0 translate-z-0 mask-active duration-400',
                  leaveToClass: '-translate-x-full translate-y-0 translate-z-0  mask-active duration-400'
              }
...
export default ptDrawerNotifications;