<script setup>
    ...
    const preset = {
        root: ({ props, state, attrs }) =>{
            ...
            // console.log(typeof props.modelValue == 'object');
            // console.log(Object.keys(props.modelValue).length);
            return {
            class: [
                ...
                { 'outline-none outline-offset-0 ring': state.focused },
                { 'border-surface-300 dark:border-surface-700 ring-primary-400/50 dark:ring-primary-300/50': !props.invalid },
                { 'border-red-500 dark:border-red-400 focus:ring-red-200 hover:border-red-500': props.invalid },
        ...
        input: ({ props }) => ({
            class: [
                ...
                'bg-transparent',
                'border-0',
                { 'text-surface-600 dark:text-white/80': (typeof props.modelValue == 'object' && Object.keys(props.modelValue).length > 0) || (typeof props.modelValue != 'object' && props.modelValue != undefined), 
                'text-surface-400 dark:text-surface-500': (typeof props.modelValue == 'object' && Object.keys(props.modelValue).length == 0) || (typeof props.modelValue != 'object' && props.modelValue == undefined)},
