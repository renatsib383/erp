const ptMultiselectNotifications = {
    root: ({ props, state }) => ({
        class: [
            'max-w-[calc(100%-35px)]',
            // Font
    ...
    label: ({ props, parent }) => ({
        class: [
            ...
            // Spacing
            {
                'py-[6px] px-3': props.display === 'comma' || (props.display === 'chip' && !props?.modelValue?.length),
...
export default ptMultiselectNotifications;
