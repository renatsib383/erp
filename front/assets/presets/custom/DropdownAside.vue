    ...
    const preset = {
        root: ({ props, state }) => ({
            class: [
                ...
                'border border-slate-400 dark:border-surface-700',
                ...
                // States
                'hover:border-slate-600 dark:hover:border-slate-900',
                { 'outline-none outline-offset-0 ring ring-slate-600/50 dark:ring-slate-700/50': state.focused },
        ...
        list: {
            class: 'py-2 list-none m-0 text-aside-base'
        },
        item: ({ context }) => ({
            class: [
                // Font
                ...
                { 'bg-surface-100 dark:bg-surface-400/40 text-slate-700 dark:text-white/80': context.focused && context.selected },
                { 'bg-surface-50 dark:bg-surface-400/40 text-slate-700 dark:text-white/80': !context.focused && context.selected },
